            ...
            <div class="container-fluid">
                        ...
                        <div class="col-lg-12 text-left">
                            <h4>
                                ...
                                <?php
                                        ...
                                        $sql = "SELECT * FROM course_instructor where course_code = '".$value2[0]."'";
                                        $result = $conn->query($sql);
                                        while($row = $result->fetch_assoc()) 
                                        {
                                            echo '<a href="'.$row['instructor_homepage'].'">&nbsp;'.$row['instructor_name'].'</a>';
                            ...
                            <div class="panel-body">
                                <div class="list-group">
                                    ...
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM course_ta where course_code = '".$value2[0]."'";
                                        $result = $conn->query($sql);
                                        while($row = $result->fetch_assoc()) 
                                        {
                                            echo '<span class="list-group-item">
                                                            <a style="float:right" href="mailto:'.$row['ta_email'].'">'.$row['ta_email'].'</a>'
                                                            .$row['ta_name'].'</span>';
                ...
                <!-- <div class="row"> -->
                    ...
                    <!-- <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-fw fa-dashboard"></i> My Courses</h3>
                            </div>
                     -->        
                     <!-- <div class="panel-body">
                                <div class="list-group"> -->
